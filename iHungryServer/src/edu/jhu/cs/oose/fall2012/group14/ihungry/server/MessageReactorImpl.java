...
public class MessageReactorImpl implements MessageReactor{
	...
	MessageReplierHandler messageReplierHandler;
	...
	private void initiateReplier(){
		messageReplierHandler = new MessageReplierHandlerImpl();
		messageReplierHandler.addReplier(new MessageReplier(){

			@Override
			public String getCommand() {
				return CommunicationProtocol.BUSI_LOGIN;
			}

			@Override
			public void replyMessage() {
					MessageReactorImpl.this.returnStringInfo(dboperator.getBusiness(inputAcc) != null,
		...
		messageReplierHandler.addReplier(new MessageReplier(){
			...
			@Override
			public String getCommand() {
				return CommunicationProtocol.BUSI_CHECK_UNAME_EXISTED;
			}

			@Override
			public void replyMessage() {
				MessageReactorImpl.this.returnStringInfo(dboperator.checkBusiUnameExisted(inputAcc),
		...
		messageReplierHandler.addReplier(new MessageReplier(){
			...
			@Override
			public String getCommand() {
				return CommunicationProtocol.BUSI_SIGNUP;
			}
		...
		messageReplierHandler.addReplier(new MessageReplier(){
			...
			@Override
			public String getCommand() {
				return CommunicationProtocol.BUSI_UPDATE_CONTACT;
			}
		...
		messageReplierHandler.addReplier(new MessageReplier(){
			...
			@Override
			public String getCommand() {
				return CommunicationProtocol.BUSI_UPDATE_ALBUM;
			}
		...
		messageReplierHandler.addReplier(new MessageReplier(){
			...
			@Override
			public String getCommand() {
				return CommunicationProtocol.BUSI_UPDATE_MENU;
			}
		...
		messageReplierHandler.addReplier(new MessageReplier(){
			...
			@Override
			public String getCommand() {
				return CommunicationProtocol.BUSI_GET_CONTACT;
			}
		...
		messageReplierHandler.addReplier(new MessageReplier(){
			...
			public String getCommand() {
				...
				return CommunicationProtocol.BUSI_GET_ALBUM;
			}
		...
		messageReplierHandler.addReplier(new MessageReplier(){
			...
			public String getCommand() {
				// TODO Auto-generated method stub
				return CommunicationProtocol.BUSI_GET_MENU;
			}
		...
		messageReplierHandler.addReplier(new MessageReplier(){
			...
			public String getCommand() {
				// TODO Auto-generated method stub
				return CommunicationProtocol.CUS_CHECK_UNAME_EXISTED;
			}
		...
		messageReplierHandler.addReplier(new MessageReplier(){
			...
			public String getCommand() {
				// TODO Auto-generated method stub
				return CommunicationProtocol.CUS_SIGN_UP;
			}
		...
		messageReplierHandler.addReplier(new MessageReplier(){
			...
			public String getCommand() {
				// TODO Auto-generated method stub
				return CommunicationProtocol.CUS_LOGIN;
			}
		...
		messageReplierHandler.addReplier(new MessageReplier(){
			...
			public String getCommand() {
				// TODO Auto-generated method stub
				return CommunicationProtocol.CUS_UPDATE_CONTACT;
			}
		...
		messageReplierHandler.addReplier(new MessageReplier(){
			...
			public String getCommand() {
				// TODO Auto-generated method stub
				return CommunicationProtocol.CUS_GET_CONTACT;
			}
		...
		messageReplierHandler.addReplier(new MessageReplier(){
			...
			public String getCommand() {
				// TODO Auto-generated method stub
				return CommunicationProtocol.CUS_FIND_RESTAURANT_IDS;
			}
		...
		messageReplierHandler.addReplier(new MessageReplier(){
			...
			public String getCommand() {
				// TODO Auto-generated method stub
				return CommunicationProtocol.CUS_GET_RES_CONTACT;
			}
		...
		messageReplierHandler.addReplier(new MessageReplier(){
			...
			public String getCommand() {
				// TODO Auto-generated method stub
				return CommunicationProtocol.CUS_GET_RES_ALBUM;
			}
		...
		messageReplierHandler.addReplier(new MessageReplier(){
			...
			public String getCommand() {
				// TODO Auto-generated method stub
				return CommunicationProtocol.CUS_GET_MENU;
			}
		...
		messageReplierHandler.addReplier(new MessageReplier(){
			...
			public String getCommand() {
				// TODO Auto-generated method stub
				return CommunicationProtocol.CUS_SUBMIT_ORDER;
			}
		...
		messageReplierHandler.addReplier(new MessageReplier(){
			...
			public String getCommand() {
				// TODO Auto-generated method stub
				return CommunicationProtocol.CUS_UPDATE_ORDER;
			}
		...
		messageReplierHandler.addReplier(new MessageReplier(){
			...
			public String getCommand() {
				// TODO Auto-generated method stub
				return CommunicationProtocol.CUS_RETRIVE_ORDER;
			}
		...
		messageReplierHandler.addReplier(new MessageReplier(){
			...
			public String getCommand() {
				// TODO Auto-generated method stub
				return CommunicationProtocol.CUS_RETRIVE_CHANGED_ORDER;
			}
		...
		messageReplierHandler.addReplier(new MessageReplier(){
			...
			public String getCommand() {
				// TODO Auto-generated method stub
				return CommunicationProtocol.BUSI_RETRIVE_ORDERS;
			}
		...
		messageReplierHandler.addReplier(new MessageReplier(){
			...
			public String getCommand() {
				// TODO Auto-generated method stub
				return CommunicationProtocol.BUSI_GET_CUS_CONTACT;
			}
		...
		messageReplierHandler.addReplier(new MessageReplier(){
			...
			public String getCommand() {
				// TODO Auto-generated method stub
				return CommunicationProtocol.BUSI_RETRIVE_CHANGED_ORDERS;
			}
		...
		messageReplierHandler.addReplier(new MessageReplier(){
			...
			public String getCommand() {
				// TODO Auto-generated method stub
				return CommunicationProtocol.BUSI_PROCESS_ORDER;
			}
	...
	public void reactToMsg(String input, final InternetUtil internet) {
		...
		try {
			...
			MessageReplier mrp = messageReplierHandler.getReplier(commandmesg);
...
//for business login
/*if(commandmesg.contains(CommunicationProtocol.CUS_GET_CONTACT)){	
	Customer cus = dboperator.getCustomer(inputAcc);
	//System.out.println(bus);
	returnStringInfo((cus != null),
			"", 
