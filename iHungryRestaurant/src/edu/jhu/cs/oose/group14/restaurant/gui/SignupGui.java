...
public class SignupGui {
	...
	public void displaySecondPageSignUpGui(){
		System.out.println("into the display method");
		Object[] statesList = {"Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"};
		signUpPanel.setVisible(false);
		{
			...
			signUpPanel2.setPreferredSize(new java.awt.Dimension(4, 5));
			{
				...
				}
				{
					...
					citySignUpT.setText("City");
				}
				{
					zipSignUpT = new JTextField();
					zipSignUpT.setText("zip");
				}
				{
					streetSignUpT = new JTextField();
					streetSignUpT.setText("Street");
				}
				{
				...
				jPanel1Layout1.setVerticalGroup(jPanel1Layout1.createSequentialGroup()
					...
					.addGap(28)
					.addComponent(citySignUpT, GroupLayout.PREFERRED_SIZE, 32, GroupLayout.PREFERRED_SIZE)
					.addGap(25)
					.addGroup(jPanel1Layout1.createParallelGroup(GroupLayout.Alignment.BASELINE)
					    .addComponent(stateSignUpT, GroupLayout.Alignment.BASELINE, GroupLayout.PREFERRED_SIZE, 32, GroupLayout.PREFERRED_SIZE)
