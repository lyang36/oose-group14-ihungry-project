...
public class AndroidClientModelImplTest extends TestCase {
	...
	//	clientmodel = new AndroidClientModelImpl();
		clientmodel = new AndroidClientModelImpl(new AccountInfo("lyang", "123"));
	}
...
/*	public void testGetResponseFromServerT() {
	...
	/*	boolean signupresult = clientmodel.signupForNewUser(username,
...
*/
	...
	public void testRetrieveMenu() {
		Menu menu = clientmodel.retrieveMenu("4dab05efe3c4f4ad97d8c5ce"); // rest nameID
