...
public class OrderHistoryActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		webView.loadData(makeOrderHistoryHTML( clientModel.retrieveAllOrders("c001") ), "text/html", "UTF-8");
	...
	private String makeEachOrderHTML(Order order_single) {
		...
		+ "       <tr>"
		+ "          <td width=\"229\" height=\"25\"><b>From:</b>  "+ order_single.getRestID() +"</td>"
		+ "        </tr>"
		+ "        <tr>"
		+ "          <td height=\"25\"><b>Status:</b> "+ order_single.getStatus() +"</td>"
		+ "        </tr>"
		+ "        <tr>"
