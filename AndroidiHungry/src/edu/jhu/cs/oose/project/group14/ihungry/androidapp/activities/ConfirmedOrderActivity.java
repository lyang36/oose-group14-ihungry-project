...
/**
 * This view is used to show the confirmed orders of the user's.
 * 
 * @author SuNFloWer
 * 
 */
public class ConfirmedOrderActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		webView.loadData(OrderHistoryTabLayoutActivity.makeOrderHistoryHTML(clientModel.retrieveOrders(Order.STATUS_CONFIRMED, -1), clientModel),
				"text/html", "UTF-8");
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		getMenuInflater().inflate(R.menu.activity_confirmed_order, menu);
		return true;
	}
