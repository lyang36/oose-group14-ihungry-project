...
/**
 * This view is used to show the rejected orders of the user's.
 * 
 * @author SuNFloWer
 * 
 */
public class RejectedOrderActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		webView.loadData(OrderHistoryTabLayoutActivity.makeOrderHistoryHTML(clientModel.retrieveOrders(Order.STATUS_REJECTED, -1), clientModel),
				"text/html", "UTF-8");
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		getMenuInflater().inflate(R.menu.activity_rejected_order, menu);
		return true;
	}
